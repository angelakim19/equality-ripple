        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a href="#" aria-label="Facebook" className="text-accent hover:text-accent/80 transition-colors">
                <Facebook size={32} />
              </a>
              <a href="#" aria-label="Instagram" className="text-accent hover:text-accent/80 transition-colors">
                <Instagram size={32} />
              </a>
              <a href="#" aria-label="Twitter" className="text-accent hover:text-accent/80 transition-colors">
                <Twitter size={32} />
              </a>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Button
                variant="outline"
                className="w-full md:w-auto border-accent text-accent hover:bg-accent hover:text-white ml-0 md:ml-3"
              >
                Donate
              </Button>
            </div>
